...
st.write("The datasets included in the project: ") 
st.image("https://raw.githubusercontent.com/Heeuul/DMProject/main/dataset.png") 
...
st.write("Most of the states have obvious effect of vaccinations on the daily cases. For example: ") 
...
st.header("4 - What is the Percentage Distribution of Each Vaccine Type? ") 
st.write("The dataset used in this question is vax_malaysia.csv. Each type of full doses given vaccines was summed up and appended to a new DataFrame.  Then, the new DataFrame is used to plot a pie chart showing percentage distribution of each vaccine types. ") 
st.caption("Pie chart showing distribution of vaccine types") 
st.image("https://raw.githubusercontent.com/Heeuul/DMProject/main/q4pie.png") 
st.write("Based on the pie chart, majority of the doses given was Pfizer (51.45%). On the other hand, only a significantly small amount received CanSino (0.69%). ") 
